...
import 'package:minder/ui/screens/auth_screens/doctor/reset_pass_for_doctor.dart';

import '../../../widgets/custom_button.dart';
import '../../../widgets/custom_text_field.dart';
class CheckYourMailDoctor extends StatefulWidget {
  const CheckYourMailDoctor({Key? key}) : super(key: key);

  @override
  State<CheckYourMailDoctor> createState() => _CheckYourMailDoctorState();
}

class _CheckYourMailDoctorState extends State<CheckYourMailDoctor> {
  @override
                  ...
                  children: [
                    Container(height: 450,width: double.infinity,
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                         const Icon(Icons.email,size: 100,color: mainColor,),
                          const Text('Check Your Email',style: TextStyle(fontSize: 24),),
                          const SizedBox(height: 8,),
                          const  Padding(
                            padding:  EdgeInsets.symmetric(horizontal: 30),
                            child: Text('We have sent you a password recover '
                                'instructions to your email',style: TextStyle(fontSize: 16,color: Color.fromRGBO(123, 122, 122, 1)),textAlign: TextAlign.center,),
                          ),
                         ...
                         const SizedBox(height: 10,),
                          Padding(
                            ...
                            child: CustomButton(
                              ...
                              textSize: 20,
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (builder)=>ResetPassForDoctor()));
                              }, fontBold: true,
                            ),
                          ),
